...
class Subscription:
    def __init__(self, msg_type: str, topic: str, callback: str, qos_service_profile: str) -> None:
    ...
    def __str__(self):
        return f"{self.__msg_type} {self.__topic} {self.__callback} {self.__qos_service_profile}"
    ...
    def __eq__(self, value: object) -> bool:
        ...
        if self.__topic != value.__topic:
            return False
        if self.__callback != value.__callback: return False
    ...
    def to_dict(self) -> dict[str, str]:
        return {
            ...
            "qos_service_profile": self.__qos_service_profile,
        }
